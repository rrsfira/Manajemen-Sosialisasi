...
const PublicHousingFilterSidebar = ({
  filterDate,
  setFilterDate,
  filterName,
  setFilterName,
  ...
  return (
    <div className="fixed inset-y-0 right-0 w-full max-w-sm lg:w-96 h-full bg-white dark:bg-gray-900 shadow-lg z-50 p-6 overflow-y-auto text-gray-800 dark:text-gray-100">
      ...
      <div className="space-y-5 pb-32">
        ...
        {/* Kolom Nama Rusun */}
        <div>
          <label className="text-base font-medium text-gray-700 dark:text-gray-200 mb-1" htmlFor="namaRusun">
            Nama Rusun
          </label>
          <input
            type="text"
...
export default PublicHousingFilterSidebar;